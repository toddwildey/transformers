# Perform a git diff of `gpt2_infinity` and `main`
git diff "$(git merge-base gpt2_infinity main)" gpt2_infinity

git diff "$(git merge-base gpt2_infinity main)" gpt2_infinity -- src
git diff "$(git merge-base gpt2_iterator main)" gpt2_iterator -- src

git diff "$(git merge-base gpt2_infinity main)" gpt2_infinity -- infinite_memory_transformer_sticky_mem

# Train GPT2-Small Iterator
